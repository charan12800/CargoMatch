-- ==============================================================================
-- CARGOMATCH SEED DATA
-- Insert initial profiles, vehicles, trips, requests, and bookings for testing
-- ==============================================================================

-- 1. Insert Driver & Customer Profiles (Using fixed UUIDs for referential integrity)
